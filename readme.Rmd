...
We learn that we can't include "Education" if we request the "Birth Rate" measure. If we try again with "Single Race" instead of "Education", it works:  
