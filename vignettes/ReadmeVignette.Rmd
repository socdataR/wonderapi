...
# 2. Add:
# Do not edit -- see vignettes/ReadmeVignette.Rmd
...
The main source of errors is improper query requests. The `wonderapi` has limited ability to catch problems before the query request is made. It checks the list of parameter names 
