...
# 2. Add:
# DON'T MAKE ANY CHANGES -- edit vignettes/ReadmeVignette.Rmd instead
...
ggplot2::ggplot(mydata2, ggplot2::aes(x = Year, y = Births, color = `Marital Status`)) +
    geom_line() + ggtitle("Births by Marital Status")
```

```{r AverageAgeofMother}
ggplot2::ggplot(mydata2, ggplot2::aes(x = Year, y = `Average Age of Mother`,
...
ggplot2::ggplot(mydata2, ggplot2::aes(x = Year, y = Unmarried / Total)) + geom_line() +
